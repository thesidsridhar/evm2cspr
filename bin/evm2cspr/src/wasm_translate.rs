...
impl<'a> ModuleBuilder<'a> {
    ...
    pub fn build(self) -> Module {
        ...
        for e in self.elements {
            ...
            {
                *table = None; // seems like cspr runtime does not support multiple tables. at least it definitely does not respect any table indexes there
            }
        ...
        match p {
            ...
            Payload::TagSection(tag_section) => {
                for tag in tag_section {
                    ...
                    panic!("only wasm core - 1 specification is supported by cspr runtime");
                    // https://github.com/cspr/csprcore/issues/8358#issuecomment-1383247423
                }
            }
